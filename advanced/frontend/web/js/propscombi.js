$(function () {
    ...
    var step = {
        ...
        //SKU信息组合
        Creat_Table: function (createData) {
            step.hebingFunction();
            ...
            arrayTile = createData[0];
            arrayInfor= createData[1];
            arrayColumn = createData[2];
            arrayIds  = createData[3];
            ...
            if (bCheck == true) {
                var RowsCount = 0;
                $("#createTable").html("");
                var table = $("<table class=\"table table-bordered\" id=\"process\" ></table>");
                ...
                var itemColumHead = $("<th  style=\"width:150px;\">价格</th><th style=\"width:150px;\">库存</th> ");
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        var td1 = $("<td ><input name=\"price["+zuheId[index]+"]\" class=\"form-control\" type=\"text\" value=\"\"></td>");
                        td1.appendTo(tr);
                        var td2 = $("<td ><input name=\"stock["+zuheId[index]+"]\" class=\"form-control\" type=\"text\" value=\"\"></td>");
                        td2.appendTo(tr);
                ...
                //创建提交按钮
                var subBtn = $("<div class=\"form-group\">"+
                    "<button type=\"submit\" class=\"btn btn-success\">创建</button>"+
                    "</div>");
                //subBtn.appendTo('#createTable');
            } else{
                //未全选中,清除表格
